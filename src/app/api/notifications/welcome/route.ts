...
export async function POST(req: Request) {
  try {
    ...
    const message = `🚀 Welcome to Route233, ${name}! Your account is now fully active.\n\nWe have linked this WhatsApp number to your digital locker. You will receive real-time alerts here for:\n1. 💰 Landed cost quotes in GHS\n2. ✈️ Philly Hub & customs status updates\n3. 📦 Delivery and MoMo receipt confirmations\n\nStart sourcing or track your items at: https://route233.com/track`;
