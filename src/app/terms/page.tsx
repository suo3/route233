  ...
  return (
    <main className="min-h-screen bg-white py-24 px-6">
      <div className="max-w-3xl mx-auto">
        ...
        <h1 className="text-5xl font-black text-slate-900 mb-8 tracking-tight">Terms of Service</h1>
        <p className="text-slate-500 mb-12">Last Updated: May 2, 2026</p>

        <div className="space-y-12 text-slate-600 leading-relaxed">
          <section>
            <h2 className="text-2xl font-bold text-slate-900 mb-4">1. Sourcing and Procurement</h2>
            <p>
          ...
          <section>
            <h2 className="text-2xl font-bold text-slate-900 mb-4">2. Payment and Quotes</h2>
            <p>
          ...
          <section>
            <h2 className="text-2xl font-bold text-slate-900 mb-4">4. Shipping and Verification</h2>
            <p>
          ...
          <section>
            <h2 className="text-2xl font-bold text-slate-900 mb-4">5. Customs and Delivery</h2>
            <p>
          ...
          <section className="bg-slate-50 p-8 rounded-3xl border border-slate-100">
            <h2 className="text-2xl font-bold text-slate-900 mb-4">6. Refunds</h2>
            <p>
